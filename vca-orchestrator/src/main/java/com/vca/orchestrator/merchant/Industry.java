...
public enum Industry {
    ...
    /**
     * 厂商侧热词表前缀里的行业部分; 前面还要拼环境前缀(见 {@code HotWordSync}), 合起来仅小写字母数字、少于 10 个字符。
     * 本机联调与线上共用一个厂商账号时, 靠环境前缀不同才不会互相覆盖对方的表。
     */
