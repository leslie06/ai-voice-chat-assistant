 ...
 * @param greetingDelayMs 接通后等多久再放开场白(ms); <=0 立刻放。模拟线/手机网络在摘机后头几百毫秒
 *                        语音通道还没建好, 立刻放会把开场白头几个字吞掉
...
public record CallConfig(
    ...
    public static CallConfig defaults() {
        return new CallConfig(20, 30_000, 24_000, 300, true, true, 20_000, 1500, 800);
    }
}
