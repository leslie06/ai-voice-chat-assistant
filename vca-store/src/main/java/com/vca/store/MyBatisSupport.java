...
final class MyBatisSupport {
    ...
    static SqlSessionFactory sqlSessionFactory(DataSource dataSource) {
        ...
        try {
            ...
            factory.getConfiguration().addMapper(PhoneCallSummaryMapper.class);
            factory.getConfiguration().addMapper(PhoneMerchantMapper.class);
            factory.getConfiguration().addMapper(PhoneGatewayMapper.class);
